            ...
            rows.append(
                {
                    ...
                    "balanced_accuracy_at_selected_threshold": float(test_confusion["balanced_accuracy"]),
...
def main() -> None:
    ...
    seed_mean_std_path = OUT_DIR / "paper_table_baf_headline_metrics_test_model_comparison_seed_mean_std.csv"
