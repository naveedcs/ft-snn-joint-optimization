...
def main() -> None:
    ...
    model_summary_path = OUT_DIR / "paper_table_fairness_cross_variant_model_summary_with_lightgbm.csv"
    attribute_summary_path = OUT_DIR / "paper_table_fairness_cross_variant_attribute_summary_with_lightgbm.csv"
    model_seed_path = OUT_DIR / "paper_table_fairness_cross_variant_model_seed_mean_std_with_lightgbm.csv"
    attribute_seed_path = OUT_DIR / "paper_table_fairness_cross_variant_attribute_seed_mean_std_with_lightgbm.csv"
